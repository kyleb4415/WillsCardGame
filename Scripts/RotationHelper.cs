...
public static class RotationHelper
{
    public static void RotateCard(Card c, Vector3 collisionPoint, SceneTree s)
    {
        ...
        c.GravityScale = 0;
        tween.TweenProperty(c, "position", new Vector3(c.PlacedPos.X, c.PlacedPos.Y + 0.6f, c.PlacedPos.Z), 0.25f).SetTrans(Tween.TransitionType.Quad);
    ...
    public static void ResetRotation(Card c, SceneTree s)
    {
        Tween tween = s.CreateTween();
        //Tween tween2 = s.CreateTween();
        //tween.TweenProperty(c, "position", new Vector3(c.PlacedPos.X, c.PlacedPos.Y, c.PlacedPos.Z), 0.25f);
